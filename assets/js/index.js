...
(function buildChanson(chansons) {
    var pageNumber = 2; // we begin at 2 because of titlePage
    forEach_1["default"](chansons, function (chanson) {
        ...
        var articleElement = chansonDOM.children[2];
        ...
        var cells = [];
        var cell = [];
        forEach_1["default"](articleElement.children, function (pElement) {
        ...
        forEach_1["default"](cells, function (cell, index) {
            var cellDOM = createCellElement(cols);
    ...
    // ---
    var menu = ulElement.getElementsByTagName('li');
