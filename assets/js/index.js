...
},{"./_arrayEach":"../node_modules/lodash/_arrayEach.js","./_baseEach":"../node_modules/lodash/_baseEach.js","./_castFunction":"../node_modules/lodash/_castFunction.js","./isArray":"../node_modules/lodash/isArray.js"}],"../node_modules/moment/moment.js":[function(require,module,exports) {
var define;
var global = arguments[3];
//! moment.js
...
(function buildChanson(chansons) {
    forEach_1["default"](chansons, function (chanson) {
        ...
        var chansonDOM = chansonTemplate_1["default"](chanson);
        main.appendChild(chansonDOM);
        var articleDOM = chansonDOM.children[2];
        ...
        if (cols > 1) {
            ...
            var createCell = function createCell(cols) {
            ...
            forEach_1["default"](articleDOM.children, function (pDOM) {
                if (cells_1.length % cols === 0) {
                    // update optimal on next pages
                    h_1.optimal = (articleDOM.offsetHeight - h_1.currentPage) / cols;
                    // console.log(optimal)
                }
                if (h_1.current > h_1.optimal) {
                    // optimal breakpoint
                    cells_1.push(cell_1);
                    cell_1 = [];
                    h_1.currentPage += h_1.current;
                    h_1.current = 0;
                }
                var style = pDOM.currentStyle || window.getComputedStyle(pDOM);
                var height = pDOM.offsetHeight + parseInt(style.marginTop) + parseInt(style.marginBottom);
                var futureCount = h_1.current + height;
                if (futureCount > h_1.firstPage && cells_1.length < cols || futureCount > h_1.pages) {
                    // page breakpoint
            ...
            // }
            var container_1 = createContainer();
            forEach_1["default"](cells_1, function (cell, index) {
                var cellDOM = createCell(cols);
                forEach_1["default"](cell, function (item) {
                    cellDOM.appendChild(item);
                });
                container_1.appendChild(cellDOM);
                if ((index + 1) % cols === 0) {
                    articleDOM.appendChild(container_1);
                    container_1 = createContainer();
                }
            });
            if (container_1.children.length !== 0) {
                articleDOM.appendChild(container_1);
            }
        }
    });
...
// })
},{"lodash/forEach":"../node_modules/lodash/forEach.js","./chansonTemplate":"chansonTemplate.ts"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
