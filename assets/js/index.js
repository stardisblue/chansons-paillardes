...
},{"./_arrayEach":"../node_modules/lodash/_arrayEach.js","./_baseEach":"../node_modules/lodash/_baseEach.js","./_castFunction":"../node_modules/lodash/_castFunction.js","./isArray":"../node_modules/lodash/isArray.js"}],"../node_modules/base64-js/index.js":[function(require,module,exports) {
'use strict'
...
},{}],"../node_modules/moment/locale/fr.js":[function(require,module,exports) {
var define;
var global = arguments[3];
...
},{"../moment":"../node_modules/moment/moment.js"}],"chansonTemplate.ts":[function(require,module,exports) {
"use strict";
...
function default_1(chanson) {
    var title = chanson.title,
        author = chanson.author,
        url = chanson.url,
        slug = chanson.slug,
        content = chanson.content,
        date = chanson.date,
        colonnes = chanson.colonnes,
        parskip = chanson.parskip;
    ...
    if (date) {
        var dateSpan = document.createElement('em');
        dateSpan.classList.add('date');
        dateSpan.innerHTML = 'dernière modification le ' + moment_1["default"](date).format('LLL') + '. ';
        p.appendChild(dateSpan);
    }
    var permalien = document.createElement('a');
    permalien.href = '#' + slug;
...
},{"moment":"../node_modules/moment/moment.js","moment/locale/fr":"../node_modules/moment/locale/fr.js"}],"index.ts":[function(require,module,exports) {
"use strict";
...
var chansonTemplate_1 = __importDefault(require("./chansonTemplate"));
function ready(fn) {
...
(function buildMenu(chansons) {
    forEach_1["default"](chansons, function (chanson) {
...
(function buildChanson(chansons) {
    ...
    forEach_1["default"](chansons, function (chanson) {
        ...
        var $chanson = chansonTemplate_1["default"](chanson);
        $main.appendChild($chanson);
        pages.push(pageNumber);
        var $article = $chanson.children[2];
        var cols = chanson.colonnes || 1;
        if (cols === 1) {
        ...
        var cells = [];
        var cell = [];
        forEach_1["default"]($article.children, function (pElement) {
            if (cells.length % cols === 0) {
                // update optimal on next pages
                h.optimal = ($article.offsetHeight - h.currentPage) / cols;
                // console.log(optimal)
            }
            if (h.current > h.optimal) {
                // optimal breakpoint
                cells.push(cell);
                cell = [];
            ...
            var style = pElement.currentStyle || window.getComputedStyle(pElement);
            var height = pElement.offsetHeight + parseInt(style.marginTop) + parseInt(style.marginBottom);
            var futureCount = h.current + height;
            if (futureCount > h.firstPage && cells.length < cols || futureCount > h.pages) {
                // page breakpoint
        ...
        if (cell.length !== 0) {
            // checking if lastcell is not empty
            cells.push(cell);
        }
        // console.log(cells)
        ...
        forEach_1["default"](cells, function (cell, index) {
            var $cell = createCellElement(cols);
            forEach_1["default"](cell, function (item) {
    ...
    // ---
    var $menu = $navigation.getElementsByTagName('li');
    forEach_1["default"]($menu, function ($li, i) {
...
(function search(chansons) {
    var $noResults = document.getElementById('nav-no-results');
    var $parents = {};
    var $toc = {};
    forEach_1["default"](chansons, function (c) {
        $parents[c.slug] = document.getElementById('parent--' + c.slug);
        $toc[c.slug] = document.getElementById('nav--' + c.slug);
    });
    var inverted = {};
    forEach_1["default"](chansons, function (chanson) {
        var tokens = tokenize(chanson.title);
        tokens.push.apply(tokens, tokenize(chanson.author));
        forEach_1["default"](tokens, function (t) {
            ;
            (inverted[t] || (inverted[t] = [])).push(chanson.slug);
        });
    });
    var searchable = lodash_1.map(inverted, function (value, key) {
        return { token: key, match: value };
    });
    function tokenize(input) {
        return lodash_1.filter(lodash_1.split(lodash_1.deburr(input).toLocaleLowerCase(), /[^a-z0-9]+/), function (t) {
            return t.length >= 2;
        });
    }
    function filterDisplay() {
        var tokens = tokenize(this.value);
        if (tokens.length === 0) {
            resetSearch();
            return;
        }
        var results;
        forEach_1["default"](tokens, function (t) {
            var filtered = lodash_1.flatMap(lodash_1.filter(searchable, function (s) {
                return lodash_1.includes(s.token, t);
            }), 'match');
            ...
            results = lodash_1.intersection(results, filtered);
        });
        if (results.length === 0) {
        ...
        var displayable = {};
        forEach_1["default"](chansons, function (c) {
            displayable[c.slug] = false;
        });
        forEach_1["default"](results, function (r) {
            displayable[r] = true;
        });
        forEach_1["default"](displayable, function (display, id) {
            var $section = $parents[id].classList;
            var $item = $toc[id].classList;
            if (display) {
                $section.remove('dn');
                $item.remove('dn');
            } else {
    ...
    var $cleanSearch = document.getElementById('clean-search');
    $cleanSearch.addEventListener('click', function (event) {
        event.preventDefault();
        $searchInput.value = '';
        resetSearch();
    });
    $searchInput.addEventListener('keydown', lodash_1.debounce(filterDisplay, 300));
...
function createCellElement(cols) {
    var $cell = document.createElement('div');
    var percentage = cols !== 3 ? 100 / cols : 'third';
...
},{"lodash/forEach":"../node_modules/lodash/forEach.js","lodash":"../node_modules/lodash/lodash.js","./chansonTemplate":"chansonTemplate.ts"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
